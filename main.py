...
def main():
    ...
    if args.command == "goal":
        if args.sub == "add": commands.goal_add(args.title, args.description, args.badge_name, args.badge_description)
        elif args.sub == "edit": commands.goal_edit(args.id, args.title, args.description, args.badge_name, args.badge_description)
        ...
        if args.sub == "add": commands.project_add(args.title, args.description, args.goal_id)
        elif args.sub == "edit": commands.project_edit(args.id, args.title, args.description, args.goal_id)
        ...
        if args.sub == "add": commands.task_add(args.title, args.project_id, args.due_date, args.priority)
        elif args.sub == "edit": commands.task_edit(args.id, args.title, args.project_id, args.due_date, args.priority)
